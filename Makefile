...
.PHONY: help setup api-dev api-test api-lint api-openapi web-dev web-build web-lint mobile-get mobile-run mobile-test mobile-analyze db-up db-down check
